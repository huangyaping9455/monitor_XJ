...
export default {
  ...
  // 获取送达企业列表
  getQiYe(params) {
    return $axios.get('/blade-platform/platform/xinxijiaohuzhuti/getQiYe', {
      params: params
    });
  },
  // 政府-获取统计车辆数据
  getVehicleList(params) {
    return $axios.get('/blade-platform/platform/gpsVehicle/getVehicleList', {
      params: params
    });
  },
  // 政府-获取政府组织树结构数据
  getTree(params) {
    return $axios.get('/blade-platform/platform/organization/getTree', {
      params: params
    });
  },
  // 政府-获取政府组织树结构数据
