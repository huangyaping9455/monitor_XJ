...
export const barcolor = [
  { 
    ...
    colorStops: [{ offset: 0, color: '#40ecc7' }, { offset: 1, color: '#15cad4' }]
  },
  { 
    type: 'linear', x: 0, y: 0, x2: 0, y2: 1,
    colorStops: [{ offset: 0, color: '#00c8f5' }, { offset: 1, color: '#0080de' }]
  },
  { 
    type: 'linear', x: 0, y: 0, x2: 0, y2: 1,
    colorStops: [{ offset: 0, color: '#ffe78d' }, { offset: 1, color: '#e3b725' }]
  },
  { 
    type: 'linear', x: 0, y: 0, x2: 0, y2: 1,
    colorStops: [{ offset: 0, color: '#00c8f5' }, { offset: 1, color: '#0080de' }]
  ...
  { 
    type: 'linear', x: 0, y: 0, x2: 0, y2: 1,
    colorStops: [{ offset: 0, color: 'rgba(24,185,73, 0.3)' }, { offset: 1, color: 'rgba(24,185,73, 0)' }]
  },
  { 
    type: 'linear', x: 0, y: 0, x2: 0, y2: 1,
    colorStops: [{ offset: 0, color: 'rgba(0,200,245, 0.3)' }, { offset: 1, color: 'rgba(0,200,245, 0)' }]
  }
]
/**
 * 柱状图配置
