  ...
  <div class="enterprise">
    ...
    <div class="main">
      ...
      <div class="main-r">
        <!-- 操作按钮 -->
        <div class="btns">
          <el-button size="mini" class="btn" icon="el-icon-search">查询</el-button>
          <el-button size="mini" class="btn"><svg-icon class="icon" icon-class="down"/>下载</el-button>
        </div>
        <!-- 查询 -->
        <el-form :inline="true" size="mini" :model="formInline" class="search">
          ...
          <el-form-item label="时间">
            <el-col :span="11" class="timetype">
              <el-form-item>
                <el-date-picker style="width: 100%;" type="date" placeholder="选择日期" v-model="formInline.date"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col class="line" :span="2">-</el-col>
            <el-col :span="11" class="timetype">
              <el-form-item>
                <el-date-picker style="width: 100%;" type="date" placeholder="选择日期" v-model="formInline.date1"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-form-item>
          <el-form-item>
        ...
        <!-- mainTable -->
        <el-table size="mini" class="mainTable" border :data="tableData" style="width: 100%">
          <el-table-column prop="date" label="排名" width="100" align="center"> </el-table-column>
          <el-table-column label="地区名称" align="center">
            <template slot-scope="{row}">
              <span class="businessName">{{row.name}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="date" label="车辆总数" align="center"> </el-table-column>
          <el-table-column label="北斗设备报警（11850）" align="center">
            <el-table-column prop="date" label="超速" align="center"> </el-table-column>
            <el-table-column prop="date" label="疲劳驾驶" align="center"> </el-table-column>
            <el-table-column prop="date" label="夜间行驶" align="center"> </el-table-column>
            <el-table-column prop="date" label="异常车辆" align="center"> </el-table-column>
          </el-table-column>
          <el-table-column label="DMS设备报警（12339）" align="center">
            <el-table-column prop="date" label="接打电话" align="center"> </el-table-column>
            <el-table-column prop="date" label="抽烟" align="center"> </el-table-column>
            <el-table-column prop="date" label="分神驾驶" align="center"> </el-table-column>
            <el-table-column prop="date" label="疲劳驾驶" align="center"> </el-table-column>
          ...
          <el-table-column prop="address" label="单车报警比" align="center"> </el-table-column>
          <el-table-column prop="address" label="报警总数" align="center"> </el-table-column>
        </el-table>
        <!-- page -->
        <div class="page">
          <div class="page-l">
